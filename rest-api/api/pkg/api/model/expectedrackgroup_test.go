...
func rackGroupValidationCases() []rackGroupValidationCase {
	device := cdbm.ExpectedRackGroupMember{Type: cdbm.ExpectedRackGroupMemberTypeNVSwitch, Manufacturer: "NVIDIA", ID: "rack-01"}
	return []rackGroupValidationCase{
		...
		{"incomplete device", APIExpectedRackGroupUpdateRequest{Members: cdbm.ExpectedRackGroupMembers{{Type: cdbm.ExpectedRackGroupMemberTypeNVSwitch, ID: "switch-01"}}}, true},
		{"Core spelling rejected", APIExpectedRackGroupUpdateRequest{Members: cdbm.ExpectedRackGroupMembers{{Type: "Switch", Manufacturer: "NVIDIA", ID: "switch-01"}}}, true},
		{"uppercase spelling rejected", APIExpectedRackGroupUpdateRequest{Members: cdbm.ExpectedRackGroupMembers{{Type: "NVSWITCH", Manufacturer: "NVIDIA", ID: "switch-01"}}}, true},
