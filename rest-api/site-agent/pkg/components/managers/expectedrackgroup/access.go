...
// NewExpectedRackGroupManager returns a new expected rack group manager.
func NewExpectedRackGroupManager(superForge *elektratypes.Elektra, superAPI *Manager.ManagerAPI, superConf *Manager.ManagerConf) *API {
